...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_rc_util_es_KeyCode__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__utils__ = __webpack_require__(102);
...
Drawer.propTypes = {
  ...
  keyboard: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.bool
};
Drawer.defaultProps = {
  prefixCls: 'drawer',
  placement: 'left',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onKeyDown = function (e) {
    if (e.keyCode === __WEBPACK_IMPORTED_MODULE_11_rc_util_es_KeyCode__["a" /* default */].ESC) {
  ...
  this.getParentAndLevelDom = function (props) {
    ...
    if (level === 'all') {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_12__utils__["b" /* dataToArray */])(level).forEach(function (key) {
    ...
    if (!windowIsUndefined) {
      _this4.levelDom.forEach(function (dom) {
        if (_this4.isOpenChange || openTransition) {
          ...
          Object(__WEBPACK_IMPORTED_MODULE_12__utils__["a" /* addEventListener */])(dom, __WEBPACK_IMPORTED_MODULE_12__utils__["f" /* transitionEnd */], _this4.transitionEnd);
          var levelValue = open ? value : 0;
          if (levelMove) {
            var $levelMove = Object(__WEBPACK_IMPORTED_MODULE_12__utils__["e" /* transformArguments */])(levelMove, { target: dom, open: open });
      ...
      if (getContainer === 'body' && showMask) {
        ...
        if (open && document.body.style.overflow !== 'hidden') {
          ...
          domArray.forEach(function (item, i) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_12__utils__["a" /* addEventListener */])(item, eventArray[i] || 'touchmove', i ? _this4.removeMoveHandler : _this4.removeStartHandler, _this4.passive);
          });
          ...
          if ((_this4.isOpenChange || openTransition) && right) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_12__utils__["g" /* transitionStr */]) {
          ...
          domArray.forEach(function (item, i) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_12__utils__["d" /* removeEventListener */])(item, eventArray[i] || 'touchmove', i ? _this4.removeMoveHandler : _this4.removeStartHandler, _this4.passive);
          });
        }
      }
    }
      ...
      __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
        'div',
        {
          ...
          style: {
            ...
            width: Object(__WEBPACK_IMPORTED_MODULE_12__utils__["c" /* isNumeric */])(width) ? width + 'px' : width,
            height: Object(__WEBPACK_IMPORTED_MODULE_12__utils__["c" /* isNumeric */])(height) ? height + 'px' : height
          },
          ref: function ref(c) {
  ...
  this.transitionEnd = function (e) {
    Object(__WEBPACK_IMPORTED_MODULE_12__utils__["d" /* removeEventListener */])(e.target, __WEBPACK_IMPORTED_MODULE_12__utils__["f" /* transitionEnd */], _this4.transitionEnd);
